(module
 ...
 (data (i32.const 1568) "\05\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1604) "\02\t")
    ...
    block $assembly/nqueens/NQ
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       ...
       i32.sub
       i32.load
       br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $assembly/nqueens/NQ $folding-inner0 $invalid
      end
      return
     end
     return
 ...
 (func $assembly/nqueens/NQ#constructor (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
