(module
 ...
 (data (i32.const 544) "\05\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\02\t\00\00\00\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 (export "nqueens" (func $assembly/index/nqueens))
 (export "memory" (memory $0))
 (start $~start)
 (func $assembly/nqueens/NQ#set:n (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store
 )
 (func $assembly/nqueens/NQ#set:count (param $0 i32) (param $1 i64)
  local.get $0
  local.get $1
  i64.store offset=8
 )
 ...
 (func $assembly/nqueens/NQ#set:board (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store offset=16
  local.get $0
 ...
 (func $assembly/nqueens/NQ~visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load offset=16
  local.tee $2
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  block $invalid
   block $~lib/array/Array<i32>
     ...
     block $~lib/arraybuffer/ArrayBufferView
      block $~lib/string/String
       block $~lib/arraybuffer/ArrayBuffer
        ...
        i32.sub
        i32.load
        br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $assembly/nqueens/NQ $~lib/array/Array<i32> $invalid
       end
       return
      end
      return
    ...
    local.get $0
    local.get $1
    call $assembly/nqueens/NQ~visit
    return
   end
   local.get $0
   local.get $1
 ...
 (func $assembly/nqueens/NQ#constructor (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  global.get $~lib/memory/__stack_pointer
  ...
  local.get $0
  i32.const 0
  call $assembly/nqueens/NQ#set:n
  local.get $0
  i64.const 0
  call $assembly/nqueens/NQ#set:count
  local.get $0
  i32.const 0
  call $assembly/nqueens/NQ#set:board
  local.get $0
  local.get $1
  call $assembly/nqueens/NQ#set:n
  local.get $0
 ...
 (func $assembly/index/nqueens (param $0 i32) (result i64)
  (local $1 i32)
  (local $2 i64)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  ...
  i32.const 0
  local.get $0
  call $assembly/nqueens/NQ#constructor
  local.tee $1
  i32.store
  local.get $1
  i64.load offset=8
